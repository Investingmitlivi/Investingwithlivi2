...
st.set_page_config(page_title="Investing-with-Livi", page_icon = "📚", layout="wide")
...
Metric, Financials,Pillar_Analysis,Stock_Analyser,EPS_Valuation,Key_ratios,Charts,Retirement_Calculator,news = st.tabs(["Metrics", "Financials","12 Pillar Process","Stock Analyzer Tool","EPS Valuation","Key Ratios","Charts","Retirement Calculator","Top 10 News"])
...
with st.container():
     with Metric:  
          ...
          try:
               ...
               print("Error: No data found for Marketcap.")

               #pass 

          if 'market_cap' not in locals():               #print("Error: No data found Marketcap.")
          ...
          #cash_equiv_annual =float(cash_equiv_annual[9])
               ...
               five_yrs_average_gross_margin="NA"
     ...
     # Handle KeyError or TypeError here
          ...
          data1 = {
          'Market Cap': [Marketcap_in_Billion],
          ...
          '5 Yr Gross Margin': [five_yrs_average_gross_margin],
                                                  ...
                                                  #-------------------------------------------------------------
                                                            ...
                                                            try:
                                                                 ...
                                                                 revenue_df = revenue_df.transpose()
                                                                      ...
                                                                      #..........................................................................................................................................
                                                                 Pretax_income_table = ["{:.2f}B".format(pretax_income / 1000000000) if abs(pretax_income) >= 1000000000 else "{:,.0f}M".format(pretax_income / 1000000) for pretax_income in Pretax_income_annual]                                                            
                                                                 Pretax_income_df = pd.DataFrame(Pretax_income_table, index=date_list_annual,  columns=["Pretax Income"])
                                                                 Pretax_income_df = Pretax_income_df.transpose()
                                                       #----------------------------------------------------------------    
...
with st.container():
     with Pillar_Analysis: 
          ...
          try:
               Average_debt_equity_one = round(((sum(debt_equity_annual_one) / len(debt_equity_annual_one))), 2)
     ...
     # Create a red circle image
          ...
          col3.metric("DEBT/FCF < 5",Schuldentillgung,schuld)
          col4.metric("DEBT/EQUITY < 2",f"{Average_debt_equity_one}",dt_equt)
     #      metrics_data = [
     #     {"": "5 Yr KGV < 23:", "Value 1": KGV, "Value 2": pe}
          ...
          col7.metric("5Yr Net Margin > 5%",f"{five_yrs_Nettomarge:.2f}%",netmarge)
...
with st.container():   
     ...
     #........................................................................................................................     
          ...
          col1.info(f"10 Yr EPS Growth YOY: {EPS_growth_10yrs}%")
          ...
          # Display the values in colored boxes
          #col1.info(f"Cost of Capital (WACC): {WACC_prozent:.2f}%")
          col1.info(f"10 Yr Revenue Growth YOY: {Revenue_growth_10years}%")
...
with st.container():              
     with Key_ratios:
          Annual, Quarter = st.tabs(["Annual", "Quarter"])
...
with st.container():
     ...
     #-------------------------------------------------------------------------------------------------
               ...
               fig = px.bar(data, x='Date', y='Dividend per Share',
                         labels={'value': 'Amount($)'},
                         title='Dividend per Share') # Use 'group' to display bars side by side
     ...
     #-------------------------------------------------------------------------------------------------
               ...
               fig = px.bar(data, x='Date', y='PE Ratio',
                         labels={'value': 'Ratio'},
                         title=f'PE Ratio Over Time:   Average 10 Yr PE Ratio: {average_PE_historical}   Average 5 Yr PE Ratio: {pe_five_:.2f}   Current PE Ratio: {pe_ttm}')  # Use 'group' to display bars side by side
...
with st.container():
     with EPS_Valuation:
          ...
          col1.info(f"WACC: {WACC_prozent:.2f}%")
     ...
     # .......................................DDM...................
          ...
          if st.button("Calculate"):
               ...
               st.write(f"Buy price: <span style='color:{font_color}'>{Buy_price_euro:.2f} €</span>", unsafe_allow_html=True)
                         #col1.write(f"Buy price:  ")
                         
                         #Buy_price = st.number_input("Buy Price:", value=Buy_price)
                        



          #col1= st.columns(1)
          #Buy_price = col1.number_input("Buy Price:", value=LOW_PE_value)
...
with st.container():
     with Retirement_Calculator:
          ...
          image = st.image('WACC copy.png', caption='Discount rate Calculation', use_column_width=True)
